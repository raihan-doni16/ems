...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::post('/repository/edit-post', [FrontController::class, 'post_edit_repository'])->name('save-repository');
    Route::get('/repository/delete/{id}', [FrontController::class, 'delete_repository'])->name('delete-repository');
