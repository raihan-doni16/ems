...
@section('content')
        <section>
                <div class="container">
                    <div class="row">
                        <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto" style="margin-top: 200px">
                        ...
                        <div
                            ...
                            <img src="img/login-img.png" alt="login" class="login-img img-move ">
